...
void loop()
{
  ...
  if ((millis() - lastTime) > timerDelay) {
    ...
    httpResponseCode = "{\"adresse\":328,\"deplacement\":['A','A','D','A','I','D','D','A','G']}";
    //           ["A1T1","A1T2","A2T2","A3T2","A3T2","A3T1","A2T1","A1T1","POSTE"]
    char json[] =  httpResponseCode ;
    ...
    //Déoupage
    const char* tab_position[100] = doc["deplacement"];
   ...
   ///////////
    int i = 0;
   while (i<6 and httpResponseCode>0)
      {
        //Croisement
